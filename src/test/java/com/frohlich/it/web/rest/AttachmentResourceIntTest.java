...
public class AttachmentResourceIntTest {
     ...
     *
     * @see com.frohlich.it.repository.search.AttachmentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
    ...
    public void updateAttachment() throws Exception {
        ...
        assertThat(testAttachment.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
